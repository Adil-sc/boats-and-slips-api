...
const { Datastore, datastore, LODGING } = require('../Datastore/datastore')
...
router.get('/', function (req, res) {
  const lodgings = get_lodgings().then((lodgings) => {
...
router.post('/', function (req, res) {
  post_lodging(req.body.name, req.body.description, req.body.price).then(
    (key) => {
